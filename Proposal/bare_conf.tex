...
Since then, I learnt during office hours after class that this may not be possible However I am not sure why it is not possible. One suggestion I got during office hours was to use the input to the final layer of a Visual Geometry Group (VGG) Very Deep Convolutional Net (VGG NET) classifier \cite{VGG} as features for an SVM to do linear separation. 
